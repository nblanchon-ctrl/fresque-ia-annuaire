...
export default function FresqueursPage() {
  ...
  const handleAdd = async (e: React.FormEvent) => {
    ...
    const { data, error } = await supabase.from('animateurs').insert({
      ...
      nom: newNom, email: newEmail, titre: newTitre,
      region: newRegion, ville: newVille, bio: newBio,
    ...
    <div className="container">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', flexWrap: 'wrap', gap: 10 }}>
        <div>
          ...
          <h1 className="page-title" style={{ marginBottom: 2 }}>{t('espace.directory')}</h1>
          ...
          <form onSubmit={handleAdd}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <input className="form-input" value={newTitre} onChange={e => setNewTitre(e.target.value)} />
              </div>
              <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <input className="form-input" value={newRegion} onChange={e => setNewRegion(e.target.value)} />
              </div>
              <div className="form-group" style={{ marginBottom: 0 }}>
                <label className="form-label">{t('directory.city')}</label>
                <input className="form-input" value={newVille} onChange={e => setNewVille(e.target.value)} />
              </div>
              ...
              <div className="form-group" style={{ marginBottom: 0, gridColumn: '1 / -1' }}>
                ...
                <textarea className="form-input" value={newBio} onChange={e => setNewBio(e.target.value)} />
              </div>
            </div>
